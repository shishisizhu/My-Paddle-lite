...
static void activate_relu_inplace(float *data, int len, float alpha, int mode) {
  ...
  if (0 == mode) {  // relu
    ...
    __m128 vec_zero_128 = __lsx_vreplgr2vr_w(0);
    for (; i + 3 < len; i += 4) {
      __m128 vec_data_128 = __lsx_vld( data + i, 0);
    ...
    for (; i + 3 < len; i += 4) {
      __m128 vec_data_128 = __lsx_vld( data + i, 0);
      __lsx_vst(__lsx_vfmin_s(__lsx_vfmax_s(vec_data_128, vec_zero_128), vec_alph_128, data + i, 0));
    }
  ...
  if (0 == mode) {  // relu
    for (j = 0; j < channel; j++) {
      ...
      for (; i + 3 < channel_size; i += 4) {
        vec_data_128 = __lsx_vld( tmp_data + i, 0);
...
static void activate_lrelu_inplace(float *data, int len, float alpha) {
  ...
  for (; i + 7 < len; i += 8) {
    ...
    __m256 vec_mask = __lasx_xvfcmp_sle_s(vec_data, vec_zero);
  ...
  for (; i + 3 < len; i += 4) {
    ...
    __m128 vec_mask_128 = __lsx_vfcmp_sle_s(vec_data_128, vec_zero_128);
...
static void activate_lrelu_inplace_bias(float *data,
  ...
  for (j = 0; j < channel; j++) {
    ...
    for (; i + 3 < channel_size; i += 4) {
      __m128 vec_data_128 =
          __lsx_vfadd_s(vec_bias_128, __lsx_vld( tmp_data + i, 0));
      __m128 vec_lr_128 = __lsx_vfmul_s(vec_data_128, vec_alph_128);
      __m128 vec_mask_128 = __lsx_vfcmp_sle_s(vec_data_128, vec_zero_128);
...
static void activate_hardswish_inplace_bias(float *data,
  ...
  for (int i = 0; i < channel; i++) {
    ...
    for (int j = 0; j < cnt; j++) {
      ...
      __m256 vin0 = __lasx_xvfadd_s((__m256)__lasx_xvld(tmp_data), vec_bias, 0);
      __m256 vin1 = __lasx_xvfadd_s((__m256)__lasx_xvld(tmp_data + 8), vec_bias, 0);
      __m256 vin2 = __lasx_xvfadd_s((__m256)__lasx_xvld(tmp_data + 16), vec_bias, 0);
      __m256 vin3 = __lasx_xvfadd_s((__m256)__lasx_xvld(tmp_data + 24), vec_bias, 0);
      ...
      __m128 vin0 = __lsx_vfadd_s(__lsx_vld( tmp_data, 0), vec_bias_128);
      __m128 vin1 = __lsx_vfadd_s(__lsx_vld( tmp_data + 4, 0), vec_bias_128);
      __m128 vin2 = __lsx_vfadd_s(__lsx_vld( tmp_data + 8, 0), vec_bias_128);
      __m128 vin3 = __lsx_vfadd_s(__lsx_vld( tmp_data + 12, 0), vec_bias_128);
      __m128 vadd0 = __lsx_vfadd_s(vin0, vec_offset_128);
      __m128 vadd1 = __lsx_vfadd_s(vin1, vec_offset_128);
      __m128 vadd2 = __lsx_vfadd_s(vin2, vec_offset_128);
      __m128 vadd3 = __lsx_vfadd_s(vin3, vec_offset_128);
      __m128 vsum0 = __lsx_vfmul_s(vin0, vec_scale_128);
      __m128 vsum1 = __lsx_vfmul_s(vin1, vec_scale_128);
      __m128 vsum2 = __lsx_vfmul_s(vin2, vec_scale_128);
      __m128 vsum3 = __lsx_vfmul_s(vin3, vec_scale_128);
      __m128 vres0 =
          __lsx_vfmin_s(__lsx_vfmax_s(vadd0, vec_zero_128), vec_threshold_128);
      __m128 vres1 =
          __lsx_vfmin_s(__lsx_vfmax_s(vadd1, vec_zero_128), vec_threshold_128);
      __m128 vres2 =
          __lsx_vfmin_s(__lsx_vfmax_s(vadd2, vec_zero_128), vec_threshold_128);
      __m128 vres3 =
          __lsx_vfmin_s(__lsx_vfmax_s(vadd3, vec_zero_128), vec_threshold_128);
      __lsx_vst(__lsx_vfmul_s(vres0, vsum0), tmp_data, 0);
      __lsx_vst(__lsx_vfmul_s(vres1, vsum1), tmp_data + 4, 0);
      __lsx_vst(__lsx_vfmul_s(vres2, vsum2), tmp_data + 8, 0);
      __lsx_vst(__lsx_vfmul_s(vres3, vsum3), tmp_data + 12, 0);
      tmp_data += 16;
...
static void activate_hardswish_inplace(
  ...
  for (int i = 0; i < cnt; i++) {
    ...
    __m128 vin0 = __lsx_vld( tmp_data, 0);
    __m128 vin1 = __lsx_vld( tmp_data + 4, 0);
    __m128 vin2 = __lsx_vld( tmp_data + 8, 0);
    __m128 vin3 = __lsx_vld( tmp_data + 12, 0);
    __m128 vadd0 = __lsx_vfadd_s(vin0, vec_offset_128);
    __m128 vadd1 = __lsx_vfadd_s(vin1, vec_offset_128);
    __m128 vadd2 = __lsx_vfadd_s(vin2, vec_offset_128);
    __m128 vadd3 = __lsx_vfadd_s(vin3, vec_offset_128);
    ...
    __m128 vres3 =
        __lsx_vfmin_s(__lsx_vfmax_s(vadd3, vec_zero_128), vec_threshold_128);
    __lsx_vst((__m128i)__lsx_vfmul_s(vres0, vsum0), tmp_data, 0);
    __lsx_vst((__m128i)__lsx_vfmul_s(vres1, vsum1), tmp_data + 4, 0);
    __lsx_vst((__m128i)__lsx_vfmul_s(vres2, vsum2), tmp_data + 8, 0);
    __lsx_vst((__m128i)__lsx_vfmul_s(vres3, vsum3), tmp_data + 12, 0);
    tmp_data += 16;
  }
